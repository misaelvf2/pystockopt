...
class Stock(Security):
    ...
    def price_change(self, start, end=None, period="1mo"):
        """Returns change in price over given time period."""
    ...
    def price_range_values(self, start, end=None, period="1mo"):
    ...
    def price_range(self, start, end=None, period="1mo"):
    ...
    def price_range_percent(self, start, end=None, period="1mo"):
...
if __name__ == "__main__":
    ...
    my_stock.save_price_history(start=datetime.date(
        2021, 10, 5), end=datetime.date(2021, 11, 6))
